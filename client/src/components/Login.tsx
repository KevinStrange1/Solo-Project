...
const AUTH_URL =
  'https://accounts.spotify.com/authorize?client_id=e665f2df3b3c4e19bbc7449267ebff04&response_type=code&redirect_uri=https://groovy-guru.vercel.app&scope=streaming%20user-read-email%20user-read-private%20user-library-read%20user-library-modify%20user-read-playback-state%20user-modify-playback-state';
